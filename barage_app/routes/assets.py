...
ROUTES = [
    ...
    ('/assets/export.xlsx', 'assets_export_xlsx', legacy.assets_export_xlsx, None),
    ...
    ('/assets/import/template.xlsx', 'assets_import_template_xlsx', legacy.assets_import_template_xlsx, None),
